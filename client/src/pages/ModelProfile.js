...
export default function ModelProfile() {
  ...
  const {jobActions, infiniteScrolling: jobInfiniteScrolling} = useJobContext();
  const param = useParams();
  const {  modelActions, infiniteScrolling: modelInfiniteScrolling } = useModelContext();
      ...
      <PageWrapper>
        <div className="d-flex justify-content-center">
          ...
          >
            ...
            <Col xs="12" className="d-flex align-items-ccenter justify-content-center gap-4 mb-3">

              <Button onClick={() => navigate(`/edit-model/${model.model_id}`)} variant="light" className=" rounded-circle"><i className="bi bi-pencil-square text-primary"></i></Button>
              <Button onClick={getModelProfile} variant="light" className=" rounded-circle"><i className="bi bi-file-earmark-arrow-down text-primary"></i></Button>
           {((user.role === 'admin' || user.role === 'root') && !model.approved) &&   <Button onClick={handleDeleteModel} variant="light" className=" rounded-circle"><i className="bi bi-trash3-fill text-danger"></i></Button>}
                    ...
                    <ListGroup variant="flush">
                      ...
                      <ListGroup.Item className="px-0">
                        <div className="ms-2 me-auto">
                          ...
                          {model.country_of_residence}
                        </div>
                      </ListGroup.Item> <ListGroup.Item className="px-0">
                        <div className="ms-2 me-auto">
...
<ListGroup.Item className="px-0">
  <div className="ms-2 me-auto">
    ...
    {model.Measurement.chest_bust_cup}
  </div>
</ListGroup.Item>
<ListGroup.Item className="px-0">
  <div className="ms-2 me-auto">
    <div className="fw-bold">Collar</div>
    {model.Measurement.collar}
  </div>
...
<ListGroup.Item className="px-0">
  <div className="ms-2 me-auto">
    ...
    {model.Measurement.around_armpit}
  </div>
</ListGroup.Item>
<ListGroup.Item className="px-0">
  <div className="ms-2 me-auto">
    <div className="fw-bold">Around thick to ankle</div>
    {model.Measurement.around_thick_to_ankle}
  </div>
...
<ListGroup.Item className="px-0">
  <div className="ms-2 me-auto">
    ...
    {model.Measurement.around_arm_to_wrist1 + "/" + model.Measurement.around_arm_to_wrist2 + "/" + model.Measurement.around_arm_to_wrist3}
  </div>
</ListGroup.Item>
<ListGroup.Item className="px-0">
  <div className="ms-2 me-auto">
    <div className="fw-bold">Arm length</div>
    {model.Measurement.arm_length1 + "/" + model.Measurement.arm_length2}
  </div>
...
<ListGroup.Item className="px-0">
  <div className="ms-2 me-auto">
    ...
    {model.Measurement.trousers_length}
  </div>
</ListGroup.Item>
<ListGroup.Item className="px-0">
  <div className="ms-2 me-auto">
    <div className="fw-bold">Chest height</div>
    {model.Measurement.chest_height}
  </div>
...
<ListGroup.Item className="px-0">
  <div className="ms-2 me-auto">
    ...
    {model.Measurement.front_shoulder}
  </div>
</ListGroup.Item>
<ListGroup.Item className="px-0">
  <div className="ms-2 me-auto">
    <div className="fw-bold">Front length</div>
    {model.Measurement.front_length}
  </div>
...
<ListGroup.Item className="px-0">
  <div className="ms-2 me-auto">
    ...
    {model.Measurement.back_shoulder}
  </div>
</ListGroup.Item>
<ListGroup.Item className="px-0">
  <div className="ms-2 me-auto">
    <div className="fw-bold">Back length</div>
    {model.Measurement.back_length}
  </div>
...
<ListGroup.Item className="px-0">
  <div className="ms-2 me-auto">
    ...
    {model.Measurement.crotch}
  </div>
</ListGroup.Item>
<ListGroup.Item className="px-0">
  <div className="ms-2 me-auto">
    <div className="fw-bold">Suit/Dress</div>
    {model.Measurement.suit_dress}
  </div>
...
<ListGroup.Item className="px-0">
  <div className="ms-2 me-auto">
    ...
    {model.Measurement.bra_size}
  </div>
</ListGroup.Item>
<ListGroup.Item className="px-0">
  <div className="ms-2 me-auto">
    <div className="fw-bold">Shoes size</div>
    {model.Measurement.shoes_size}
  </div>
...
<ListGroup.Item className="px-0">
  <div className="ms-2 me-auto">
    ...
    {model.Measurement.hair_colour}
  </div>
</ListGroup.Item>
<ListGroup.Item className="px-0">
  <div className="ms-2 me-auto">
    <div className="fw-bold">Eye colour</div>
    {model.Measurement.eye_colour}
  </div>
                ...
                <Accordion.Item eventKey="4">
                  ...
                  <Accordion.Body>
                    <Image className="my-3" fluid={true} src={process.env.REACT_APP_API_END_POINT + model.profile_img_2}/>

                    <Image  className="my-3" fluid={true} src={process.env.REACT_APP_API_END_POINT + model.profile_img_3}/>

                    <Image  className="my-3" fluid={true} src={process.env.REACT_APP_API_END_POINT + model.profile_img_4}/>

                    <Image  className="my-3" fluid={true} src={process.env.REACT_APP_API_END_POINT + model.profile_img_5}/>

                    <Image  className="my-3" fluid={true} src={process.env.REACT_APP_API_END_POINT + model.profile_img_6}/>
