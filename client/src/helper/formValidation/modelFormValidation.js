...
export const createModelSchema = object({
  ...
  phone_number: string().required('Phone number cannot be empty.'),
  email: string().email("Email must be a valid email.").required("Email cannot be empty"),
  line_id: string().nullable(),
  whatsApp: string().nullable(),
  weChat: string().nullable(),
  instagram: string().nullable(),
  facebook: string().nullable(),
  date_of_birth: date().required("Date of birth cannot be empty."),
  gender: string().required("Gender cannot be empty."),
  age: string().required("Age cannot be empty."),
  ...
  in_town: boolean(),
  emergency_contact_name: string().required("Emergency contact name cannot be empty."),
  emergency_contact_relationship: string().nullable(),
  emergency_contact_details: string().required("Emergency contact details cannot be empty."),
  [1]: mixed().required('Not all required images are uploaded'),
  [2]: mixed().required('Not all required images are uploaded'),
  [3]: mixed().required('Not all required images are uploaded'),
  [4]: mixed().required('Not all required images are uploaded'),
  [5]: mixed(),
  [6]: mixed(),
